 ...
 * Files are stored in {@code .minecraft/ghostclient/configs/<ModuleName>.json}.
 */
public class ConfigManager {

    private static final Logger LOGGER = LoggerFactory.getLogger("GhostClient/Config");
    ...
    public ConfigManager(ModuleManager moduleManager) {
        ...
        this.configDir = gameDir.toPath().resolve("ghostclient").resolve("configs");
    }
    ...
    public void load() {
        if (!Files.isDirectory(configDir)) {
            LOGGER.info("No config directory found — using defaults.");
            return;
        }
