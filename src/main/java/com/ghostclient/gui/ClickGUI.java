package com.ghostclient.gui;

import com.ghostclient.GhostClient;
import com.ghostclient.gui.components.CategoryPanel;
...
import com.ghostclient.util.ColorUtil;
...
public class ClickGUI extends Screen {
    ...
    protected void init() {
        panels.clear();
        ModuleManager mm = GhostClient.getInstance().getModuleManager();
        int x = 10;
