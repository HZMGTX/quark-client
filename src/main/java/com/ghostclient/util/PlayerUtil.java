...
public final class PlayerUtil {
     ...
     * position — i.e. the block is solid and the two blocks above it are passable.
     *
    ...
    /**
     * Returns the local player's current health (0–20).
     */
    ...
    /**
     * Returns the local player's current food level (0–20).
     */
