 ...
 *
 * Color scheme:
 *   Chest        → orange (1.0, 0.6, 0.1)
 *   Trapped Chest → red   (1.0, 0.2, 0.2)
 *   Barrel       → brown  (0.6, 0.4, 0.1)
 *   Hopper       → gray   (0.6, 0.6, 0.6)
 *   Dropper      → yellow (1.0, 1.0, 0.2)
 *   Dispenser    → cyan   (0.2, 0.8, 1.0)
 *   Furnace      → silver (0.8, 0.8, 0.8)
 *   Shulker Box  → purple (0.7, 0.2, 1.0)
 */
