...
/**
 * Abstract base class for every GhostClient module (hack).
 *
 * <p>Subclasses register their settings in the constructor via {@link #register}.
 * Event handling is done through {@link com.ghostclient.event.EventHandler}-annotated
...
public abstract class Module {
    ...
    /** Shared MC instance — safe to access from module code on the render/game thread. */
