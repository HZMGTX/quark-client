...
/**
 * Central event bus for GhostClient.
 *
...
public class EventBus {
    ...
    /** Map from event class → ordered list of listener entries. */
    ...
    public <T extends Event> T post(T event) {
        ...
        for (ListenerEntry entry : snapshot) {
            ...
            try {
                ...
                System.err.println("[GhostClient EventBus] Exception in listener: " + t.getMessage());
