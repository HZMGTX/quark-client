...
/**
 * AutoSnowball - throws snowballs at nearby targets automatically.
 */
public class AutoSnowball extends Module {
    ...
    public AutoSnowball() {
        super("AutoSnowball", "Throws snowballs at nearby targets", Category.COMBAT);
    }
    ...
    public void onTick(EventTick event) {
        ...
        if (!mc.player.getMainHandStack().isOf(Items.SNOWBALL)) return;
        ticks++;
