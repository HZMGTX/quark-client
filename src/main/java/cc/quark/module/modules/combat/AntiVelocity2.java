...
public class AntiVelocity2 extends Module {
    ...
    public void onPacketReceive(EventPacketReceive event) {
        ...
        double vx = (packet.velocityX() / 8000.0) * horizontalFactor.get();
        double vy = (packet.velocityY() / 8000.0) * verticalFactor.get();
        double vz = (packet.velocityZ() / 8000.0) * horizontalFactor.get();
