...
public class ExplosionIndicator extends Module {
    ...
    public ExplosionIndicator() { super("ExplosionIndicator", "Warning indicator for incoming explosions", Category.RENDER); }
