...
public class PumpkinFarm extends Module {
    ...
    public PumpkinFarm() {
        super("PumpkinFarm", "Breaks grown pumpkin blocks nearby", Category.WORLD);
    }
    ...
    public void onTick(EventTick event) {
        ...
        for (BlockPos pos : BlockPos.iterate(center.add(-r, -2, -r), center.add(r, 2, r))) {
            if (!mc.world.getBlockState(pos).isOf(Blocks.PUMPKIN)) continue;
