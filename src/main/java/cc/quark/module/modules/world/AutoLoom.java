...
public class AutoLoom extends Module {
    ...
    private final IntSetting patternSlot = register(new IntSetting("Pattern", "Pattern", 0, 0, 15));
    private final IntSetting delay = register(new IntSetting("Delay", "Delay", 3, 1, 10));
