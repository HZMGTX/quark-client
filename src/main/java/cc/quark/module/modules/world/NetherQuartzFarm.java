...
public class NetherQuartzFarm extends Module {
    ...
    public NetherQuartzFarm() { super("NetherQuartzFarm", "Automates nether quartz mining and collection", Category.WORLD); }
