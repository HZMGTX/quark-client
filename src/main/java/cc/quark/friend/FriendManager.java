 ...
 * The list is persisted to {@code .minecraft/quark/friends.json}.
 */
public class FriendManager {

    private static final Logger LOGGER = LoggerFactory.getLogger("Quark/Friends");
    ...
    public FriendManager() {
        ...
        Path ghostDir = gameDir.toPath().resolve("quark");
