...
/**
 * General mathematical utilities used across Quark modules.
 */
public final class MathUtil {
    ...
    /**
     * Linearly interpolate between {@code a} and {@code b} by factor {@code t} (0â€“1).
     *
     * @param a start value
     * @param b end value
     ...
     * @param fov    half-angle of the FOV cone in degrees (e.g. 90 = full 180Â° cone)
