...
const MODULE_CATALOG = [
    ...
    { category: 'HUD',    name: 'CPS',           description: 'Standalone click-per-second counter' },
    ...
    { category: 'HUD',    name: 'Health',        description: 'Live health + absorption' },
    { category: 'HUD',    name: 'Hunger',        description: 'Live food level' },
    { category: 'HUD',    name: 'Speed',         description: 'Horizontal speed in blocks/sec' },
    { category: 'HUD',    name: 'HeldItem',      description: 'Name + count of the held item' },
    { category: 'HUD',    name: 'ServerIP',      description: 'Address of the current server' },
    { category: 'HUD',    name: 'GameTime',      description: 'In-game day + clock' },
    { category: 'HUD',    name: 'Memory',        description: 'JVM heap usage' },
    { category: 'HUD',    name: 'SessionInfo',   description: 'Your username + FPS' },
